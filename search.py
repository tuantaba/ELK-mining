...
try:
    ...
    elastic_client = Elasticsearch([ELK_HOST], maxsize=999999, http_auth=(USERNAME, PASSWORD), verify_certs=False)
...
def make_query(filter):    
    ...
    try:        
        ...
        response = elastic_client.search(index=INDEX_NAME,body=filter,size=99999999,track_total_hits=True)
