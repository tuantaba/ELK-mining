...
class AppMetrics:
    ...
    def __init__(self, polling_interval_seconds=5):
        ...
        self.duration_time = Histogram('duration_time', 'Duration Time in miliseconds', ['domain'], buckets=(50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 2000 , 4000, 6000, 8000, 10000, 20000, _INF))
        ...
        try: 
            ...
            for data_load in all_data_load:      
                ...
                try:
                    ...
                    self.duration_time.labels(domain).observe(int(duration_time))                        
...
def main():
    ...
    polling_interval_seconds = int(os.getenv("POLLING_INTERVAL_SECONDS", "60"))  #set to 60s  #86400
